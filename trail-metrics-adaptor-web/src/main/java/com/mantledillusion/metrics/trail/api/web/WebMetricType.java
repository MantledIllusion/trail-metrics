...
/**
 * A type for {@link WebMetric}s. Different types might be interpreted differently by a {@link WebMetricConsumer}.
 */
@XmlEnum
public enum WebMetricType {
	...
	/**
	 * WebMetric that marks the begin of a new phase in a sequence of events with the
	 * same category.
	 * <p>
	...
	/**
	 * WebMetric that signals an absolute magnitude of a specific value at the moment
	...
	/**
	 * WebMetric that signals a relative change to a specific value at the moment the
