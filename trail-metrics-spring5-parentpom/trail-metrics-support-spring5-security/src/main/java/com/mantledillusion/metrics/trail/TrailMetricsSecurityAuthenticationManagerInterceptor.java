...
/**
 * AspectJ @{@link Aspect} that intercepts {@link org.springframework.security.authentication.AuthenticationManager#authenticate(Authentication)}
 * to dispatch events when a provider attempts authentication.
 * <p>
 * Requires Spring AOP's @{@link EnableAspectJAutoProxy} to be active.
 */
@Aspect
public class TrailMetricsSecurityAuthenticationManagerInterceptor {

    private static final String ASPECTJ_SPRING_AUTHENTICATION_MANAGER_METHOD_MATCHER = "execution(* org.springframework.security.authentication.AuthenticationManager.authenticate(org.springframework.security.core.Authentication))";
    private static final ThreadLocal<Long> THREAD_LOCAL = new ThreadLocal<>();

    private static final String MID_AUTHENTICATION = "spring.security.manager";
    private static final String AKEY_AUTHENTICATION_PROVIDER = "authenticationManager";
    ...
    public static final String PRTY_DISPATCH_SUCCESS = "trailMetrics.security.manager.dispatch";
