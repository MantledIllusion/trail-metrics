...
public class TrailMetricsHibernateJpaAutoConfigurationTest {
    ...
    private static final LocalDateTime METRIC_TIMESTAMP;
    ...
    static {
        ...
        // REQUIRED WHEN BUILDING WITH Java9+ SINCE PRECISION OF now() IS HIGHER THAN DATABASE TIMESTAMP PRECISION
        now = now.minusNanos(now.getNano() % 1_000_000);
